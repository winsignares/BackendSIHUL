...
urlpatterns = [
    ...
    path('get_rol/', views.get_rol, name='get_rol'),
    ...
    path('get_sede/', views.get_sede, name='get_sede'),
    path('list_sedes/', views.list_sedes, name='list_sedes'),
    ...
    path('get_facultad/', views.get_facultad, name='get_facultad'),
    path('list_facultades/', views.list_facultades, name='list_facultades'),
    ...
    path('list_programas/', views.list_programas, name='list_programas'),
    ...
    path('get_periodo/', views.get_periodo, name='get_periodo'),
    path('list_periodos/', views.list_periodos, name='list_periodos'),
    ...
    path('get_grupo/', views.get_grupo, name='get_grupo'),
    path('list_grupos/', views.list_grupos, name='list_grupos'),
    ...
    path('get_asignatura/', views.get_asignatura, name='get_asignatura'),
    path('list_asignaturas/', views.list_asignaturas, name='list_asignaturas'),
    ...
    path('get_espacio/', views.get_espacio, name='get_espacio'),
    path('list_espacios/', views.list_espacios, name='list_espacios'),
    ...
    path('get_recurso/', views.get_recurso, name='get_recurso'),
    path('list_recursos/', views.list_recursos, name='list_recursos'),
    ...
    path('get_espacio_recurso/', views.get_espacio_recurso, name='get_espacio_recurso'),
    path('list_espacio_recursos/', views.list_espacio_recursos, name='list_espacio_recursos'),
    ...
    path('get_usuario/', views.get_usuario, name='get_usuario'),
    ...
    path('get_horario/', views.get_horario, name='get_horario'),
    ...
    path('get_horario_fusionado/', views.get_horario_fusionado, name='get_horario_fusionado'),
    path('list_horarios_fusionados/', views.list_horarios_fusionados, name='list_horarios_fusionados'),
    ...
    path('get_prestamo/', views.get_prestamo, name='get_prestamo'),
